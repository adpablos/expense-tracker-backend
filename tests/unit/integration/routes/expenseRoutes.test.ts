...
testContainer.rebind(TYPES.ExpenseService).toConstantValue(mockExpenseService);
...
describe('Expense Routes', () => {
    ...
    describe('DELETE /api/expenses/:id', () => {
        ...
        it('should return 404 when expense is not found', async () => {
            ...
            (mockExpenseService.deleteExpense as jest.Mock).mockRejectedValue(new AppError('Expense not found', 404));
            (mockHouseholdService.userHasAccessToHousehold as jest.Mock).mockResolvedValueOnce(true);
