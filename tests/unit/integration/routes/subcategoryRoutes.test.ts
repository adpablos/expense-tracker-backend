...
describe('Subcategory Routes', () => {
    ...
    describe('GET /api/subcategories', () => {
        ...
        it('should return subcategories when user has access to the specified household', async () => {
            ...
            (mockSubcategoryService.getAllSubcategories as jest.Mock).mockResolvedValueOnce(mockSubcategories);
    ...
    describe('POST /api/subcategories', () => {
        it('should create a new subcategory', async () => {
            ...
            (mockHouseholdService.userHasAccessToHousehold as jest.Mock).mockResolvedValueOnce(true);
            (mockSubcategoryService.createSubcategory as jest.Mock).mockResolvedValueOnce(createdSubcategory);
    ...
    describe('PUT /api/subcategories/{id}', () => {
        it('should update an existing subcategory', async () => {
            ...
            (mockSubcategoryService.updateSubcategory as jest.Mock).mockResolvedValueOnce(mockUpdatedSubcategory);
            (mockHouseholdService.userHasAccessToHousehold as jest.Mock).mockResolvedValueOnce(true);
        ...
        it('should return 404 when subcategory is not found', async () => {
            ...
            (mockSubcategoryService.updateSubcategory as jest.Mock).mockRejectedValueOnce(new AppError('Subcategory not found', 404));
            (mockHouseholdService.userHasAccessToHousehold as jest.Mock).mockResolvedValueOnce(true);
    ...
    describe('DELETE /api/subcategories/{id}', () => {
        ...
        it('should return 404 when subcategory is not found', async () => {
            ...
            (mockSubcategoryService.deleteSubcategory as jest.Mock).mockRejectedValueOnce(new AppError('Subcategory not found', 404));
            (mockHouseholdService.userHasAccessToHousehold as jest.Mock).mockResolvedValueOnce(true);
